...
class AppColors {
  ...
  static const Color gradientStart = Color(0xFFFFDE59); // Yellow
  static const Color gradientEnd = Color(0xFFFF914D);   // Orange
